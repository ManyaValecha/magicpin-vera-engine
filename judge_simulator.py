...
# Choose your LLM provider: "openai", "anthropic", "gemini", "deepseek", "groq", "ollama", "openrouter", "cohere"
LLM_PROVIDER = "cohere"

# Your API key (paste your key here)
LLM_API_KEY = "98bZ48NaxH1zoPf51tlQ44yIoByYD6NsiWCJzlGz"  # <-- PUT YOUR API KEY HERE
